...
que un conjunto de datos con una fila por cada observación se denomina datos largos o (ya que hay muchas filas). En la mayoría de los 
casos, es más fácil trabajar con datos largos y, de hecho, en la jerga de 'tidyverse', estos datos se denominan “*tidy data*” (datos ordenados).
